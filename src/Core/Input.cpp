...
void Input::Update()
{
    ...
    // Note: Scroll is set by callback, we just reset it here
    // Actually, we should reset it at the end of frame or keep it
    // For now, let's keep the scroll value and reset it here
    mouseScroll_ = Vec2(0.0f);
}
