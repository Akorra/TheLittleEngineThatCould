...
Render::Mesh GeometryFactory::CreateCube(float size) 
{
    Render::Mesh mesh;
...
Render::Mesh GeometryFactory::CreateSphere(float radius, uint32 segments, uint32 rings) 
{
    Render::Mesh mesh;
...
Render::Mesh GeometryFactory::CreatePlane(float width, float height, uint32 widthSegments, uint32 heightSegments) 
{
    Render::Mesh mesh;
...
Render::Mesh GeometryFactory::CreateCylinder(float radius, float height, uint32 segments) 
{
    Render::Mesh mesh;
...
Render::Mesh GeometryFactory::CreateCone(float radius, float height, uint32 segments) 
{
    Render::Mesh mesh;
...
Render::Mesh GeometryFactory::CreateTorus(float majorRadius, float minorRadius, uint32 majorSegments, uint32 minorSegments) 
{
    Render::Mesh mesh;
...
Render::Mesh GeometryFactory::CreateQuad(float width, float height) 
{
    return CreatePlane(width, height, 1, 1);
}

Render::Mesh GeometryFactory::CreateCapsule(float radius, float height, uint32 segments, uint32 rings) 
{
    Render::Mesh mesh;
...
Render::Mesh GeometryFactory::CreateIcosphere(float radius, uint32 subdivisions) 
{
    Render::Mesh mesh;
