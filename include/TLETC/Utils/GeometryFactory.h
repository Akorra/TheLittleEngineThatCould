...
public:
     ...
     */
    static Render::Mesh CreateCube(float size = 1.0f);
     ...
     */
    static Render::Mesh CreateSphere(float radius = 0.5f, uint32 segments = 32, uint32 rings = 16);
     ...
     */
    static Render::Mesh CreatePlane(float width = 1.0f, float height = 1.0f, uint32 widthSegments = 1, uint32 heightSegments = 1);
     ...
     */
    static Render::Mesh CreateCylinder(float radius = 0.5f, float height = 1.0f, uint32 segments = 32);
     ...
     */
    static Render::Mesh CreateCone(float radius = 0.5f, float height = 1.0f, uint32 segments = 32);
     ...
     */
    static Render::Mesh CreateTorus(float majorRadius = 0.5f, float minorRadius = 0.2f, uint32 majorSegments = 32, uint32 minorSegments = 16);
     ...
     */
    static Render::Mesh CreateQuad(float width = 1.0f, float height = 1.0f);
     ...
     */
    static Render::Mesh CreateCapsule(float radius = 0.5f, float height = 1.0f, uint32 segments = 32, uint32 rings = 8);
     ...
     */
    static Render::Mesh CreateIcosphere(float radius = 0.5f, uint32 subdivisions = 2);
};
